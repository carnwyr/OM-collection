$(function() {
  ...
  cards.filter(x => x.type === "Memory").forEach((card, i) => {
    if (card.rarity !== "SR") {
      ...
      <img src="https://obey-me.fandom.com/wiki/Special:Redirect/file/${cardName}_${characterNum}_icon.png?width=128" onerror="this.src='/images/reward_placeholder.png'" style="width:128px;height:auto;">
      </a></div>`;
      $("#memory").append(text);
    }
  });
